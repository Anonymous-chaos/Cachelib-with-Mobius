...
template <typename CacheTrait>
bool CacheItem<CacheTrait>::markInMMContainer() noexcept {
  return ref_.markInMMContainer();
}

template <typename CacheTrait>
bool CacheItem<CacheTrait>::unmarkInMMContainer() noexcept {
  return ref_.unmarkInMMContainer();
}
