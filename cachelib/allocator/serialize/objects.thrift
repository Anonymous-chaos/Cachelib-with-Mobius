...
struct MMClockObject {
  ...
  8: required CClockListObject fifo,
...
struct MMMobiusConfig {
  2: required bool updateOnWrite,
  4: bool updateOnRead = true,
  5: bool tryLockUpdate = false,
}

struct MMMobiusObject {
  1: required MMMobiusConfig config,

  // number of evictions for this MM object.
  5: i64 evictions = 0,

  8: required MobiusObject mlist,
}

struct MMMobiusCollection {
  1: required map<i32, map<i32, MMMobiusObject>> pools,
}
