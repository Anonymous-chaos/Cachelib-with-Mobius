...
struct MobiusObject {
  1: required i64 compressedHead0,
  2: required i64 compressedTail0,
  3: required i64 compressedHead1,
  4: required i64 compressedTail1,
  5: required i64 size,
}
